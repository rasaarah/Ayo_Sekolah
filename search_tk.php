<?php
  ...
  function build_query($user_search) {
    $search_query = "SELECT * FROM tk INNER JOIN kecamatan ON tk.id_kecamatan=kecamatan.id_kecamatan  ";
 ...
 echo' <div class="row">';
    ...
    echo '<p><a href="maps_tk.php?page=maps&id_tk='.$row['id_tk'].'" >Lihat maps</a></p>';
      echo'</div>';
      echo'  </div>';
   echo'   <hr>';
