        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
					...
					aria-hidden="true"></i> <span class="network-name"> Lihat Daftar PAUD & TK</span></a>
                </div>
				<br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
					...
					aria-hidden="true"></i> <span class="network-name"> Lihat Daftar SD</span></a>
                </div>
				<br>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-sm-6">
					...
					aria-hidden="true"></i> <span class="network-name"> Lihat Daftar SMP</span></a>					
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-lg-offset-1 col-sm-push-6  col-sm-6">
					...
					aria-hidden="true"></i> <span class="network-name"> Lihat Daftar SMA/SMK</span></a>
